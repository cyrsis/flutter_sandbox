...
class StockHomeState extends State<StockHome> {
  ...
  void _handleStockMenu(BuildContext context, StockMenuItem value) {
    switch (value) {
      case StockMenuItem.autorefresh:
        setState(() {
          _autorefresh = !_autorefresh;
        });
        break;
      case StockMenuItem.refresh:
        showDialog<void>(
          context: context,
          builder: (BuildContext context) => new NotImplementedDialog(),
        );
        break;
      case StockMenuItem.speedUp:
        timeDilation /= 5.0;
        break;
      case StockMenuItem.speedDown:
        timeDilation *= 5.0;
        break;
    }
  }
    ...
    return new AppBar(
      ...
      actions: <Widget>[
        ...
        new PopupMenuButton<StockMenuItem>(
          onSelected: (StockMenuItem value) { _handleStockMenu(context, value); },
