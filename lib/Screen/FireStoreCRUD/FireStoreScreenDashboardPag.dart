...
class FireStoreScreenDashboardPage extends StatefulWidget {
  @override
  _FireStoreScreenDashboardPageState createState() => _FireStoreScreenDashboardPageState();
}

class _FireStoreScreenDashboardPageState extends State<FireStoreScreenDashboardPage> {
  String carModel;
  String carColor;
