...
class BurgerTruckScreen extends StatefulWidget {
  @override
  _BurgerTruckScreenState createState() => new _BurgerTruckScreenState();
}

class _BurgerTruckScreenState extends State<BurgerTruckScreen> {
  int photoIndex = 0;
  List<String> photos = [
