...
class FoodReceiptScreen extends StatefulWidget {
  @override
  _FoodReceiptScreenState createState() => new _FoodReceiptScreenState();
}

class _FoodReceiptScreenState extends State<FoodReceiptScreen> {
