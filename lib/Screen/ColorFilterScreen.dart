...
//Intention:
//Blend is add some color into a image

class ColorFiltersScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => ColorFiltersScreenState();
}

class ColorFiltersScreenState extends State<ColorFiltersScreen> {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
        body: Stack(
          children: <Widget>[
            Image.asset(
              AppImage.colorblend_backgroundbg,
