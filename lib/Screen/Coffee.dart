...
class CoffeeShopScreen extends StatefulWidget {
  @override
  _CoffeeShopScreenState createState() => new _CoffeeShopScreenState();
}
  ...
  Widget _buildUmbella() {
    if (_isFavorited) {
      return new CircleKProductCard(
        assetpath: "assets/Coffee/coffee_in_bed.jpg",
        icon: Icons.add_alert,
        iconbackgrouncolor: Colors.black,
        title: "Pacific High Cofee",
        subtitle: "The best your money can buy",
        heartcount: 22,
      );
    }
