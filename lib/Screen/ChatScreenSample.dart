  ...
  Widget build(BuildContext ctx) {
    return new MaterialApp(
      ...
      theme: defaultTargetPlatform == TargetPlatform.iOS
          ? iOSTheme
          : androidTheme,
      home: new ChatScreenSample(),
    );
  }
}

class ChatScreenSample extends StatefulWidget {
  @override
  State createState() => new ChatScreenState();
}

class ChatScreenState extends State<ChatScreenSample> with TickerProviderStateMixin {
