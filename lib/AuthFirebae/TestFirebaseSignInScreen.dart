...
class TestFirebaseSignInScreen extends StatefulWidget {
  TestFirebaseSignInScreen({Key key, this.title :"Test Firebase Auth"}) : super(key: key);

  final String title;

  @override
  _TestFirebaseSignInScreenState createState() => _TestFirebaseSignInScreenState();
}

class _TestFirebaseSignInScreenState extends State<TestFirebaseSignInScreen> {
