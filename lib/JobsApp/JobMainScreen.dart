...
import 'package:flutter_sandbox/JobsApp/CompanyCircle.dart';
import 'package:flutter_sandbox/JobsApp/CustomDrawer.dart';
import 'package:flutter_sandbox/JobsApp/DetailScreen.dart';
import 'package:flutter_sandbox/JobsApp/Model/Job.dart';
...
class _JobMainScreenState extends State<JobMainScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppStyle.bkColor,
      appBar: AppBar(
        actions: <Widget>[
          IconButton(
