...
import 'package:flutter_sandbox/ReduxActions.dart/main.dart';
...
class ReduxAppExample extends StatelessWidget {
  ReduxAppExample({Key key, this.store}) : super(key: key);
